      ...
      arguments.add(
          Substitution.of(
              ...
              "export WORKSPACE_PREFIX="
                  ...
                  + File.separator
                  + workspacePrefix
                  + testRuntimeClasspathArtifact.getOutputRelativePathString()));
    } else {
      arguments.add(
        ...
        arguments.add(
            Substitution.of(
                ...
                "export JACOCO_METADATA_JAR=${JAVA_RUNFILES}/"
                    + workspacePrefix
                    + "/"
                    + runtimeClassPathArtifact.getOutputRelativePathString()));
      } else {
      ...
      if (JavaSemantics.useLegacyJavaTest(ruleContext)) {
        ...
        if (testConfiguration.getTestArguments().isEmpty()
          ...
          for (Artifact artifact : sources) {
            PathFragment path = artifact.getOutputRelativePath();
